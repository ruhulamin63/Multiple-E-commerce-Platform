                            ...
                            <table class="table table-striped table-md">
                                ...
                                @foreach ($products as $key => $value)
                                    <tr id="row_{{ $value->id }}" class="table-data-row">
                                        ...
                                        <td>
                                            @if($value->product)
                                                <a href="{{ route('product-details',$value->product->slug) }}"
                                                   target="_blank">{{ $value->product->getTranslation('name', \App::getLocale()) }}</a>
                                            @endif

                                        </td>
                                        <td> {{ $value->discount_type == 'percentage' ? round($value->discount,2) : get_price($value->discount)  }} </td>
