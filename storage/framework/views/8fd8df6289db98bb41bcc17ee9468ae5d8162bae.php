...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57"
          href="<?php echo e(static_asset('images/ico/favicon-57x57.png')); ?>">
    <link rel="apple-touch-icon" sizes="60x60"
          href="<?php echo e(static_asset('images/ico/favicon-60x60.png')); ?>">
    <link rel="apple-touch-icon" sizes="72x72"
          href="<?php echo e(static_asset('images/ico/favicon-72x72.png')); ?>">
    <link rel="apple-touch-icon" sizes="76x76"
          href="<?php echo e(static_asset('images/ico/favicon-76x76.png')); ?>">
    <link rel="apple-touch-icon" sizes="114x114"
          href="<?php echo e(static_asset('images/ico/favicon-114x114.png')); ?>">
    <link rel="apple-touch-icon" sizes="120x120"
          href="<?php echo e(static_asset('images/ico/favicon-120x120.png')); ?>">
    <link rel="apple-touch-icon" sizes="144x144"
          href="<?php echo e(static_asset('images/ico/favicon-144x144.png')); ?>">
    <link rel="apple-touch-icon" sizes="152x152"
          href="<?php echo e(static_asset('images/ico/favicon-152x152.png')); ?>">
    <link rel="apple-touch-icon" sizes="180x180"
          href="<?php echo e(static_asset('images/ico/favicon-180x180.png')); ?>">
    <link rel="icon" type="image/png" sizes="192x192"
          href="<?php echo e(static_asset('images/favicon-192x192.png')); ?>">
    <link rel="icon" type="image/png" sizes="32x32"
          href="<?php echo e(static_asset('images/ico/favicon-32x32.png')); ?>">
    <link rel="icon" type="image/png" sizes="96x96"
          href="<?php echo e(static_asset('images/ico/favicon-96x96.png')); ?>">
    <link rel="icon" type="image/png" sizes="16x16"
          href="<?php echo e(static_asset('images/ico/favicon-16x16.png')); ?>">
    <link rel="manifest" href="<?php echo e(static_asset('images/ico/manifest.json')); ?>">

    <link rel='stylesheet' type='text/css'
          href="<?php echo e(static_asset('install/bootstrap/css/bootstrap.min.css')); ?>"/>
    <link rel='stylesheet' type='text/css'
          href="<?php echo e(static_asset('install/js/font-awesome/css/font-awesome.min.css')); ?>"/>

    <link rel='stylesheet' type='text/css' href="<?php echo e(static_asset('install/css/install.css')); ?>"/>
</head>
<body>
        ...
        <div class="panel-body no-padding">
            ...
            <div class="tab-content">
                        ...
                        <div>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>On</td>
                                    <td class="text-center">
                                        <i class="status fa <?php echo e(class_exists('ZipArchive') ? 'fa-check-circle-o' : 'fa-times-circle-o'); ?>"></i>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                ...
                <div role="tabpanel" class="tab-pane" id="configuration-tab">
                    <form name="config-form" id="config-form" action="<?php echo e(route('install.process')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="section clearfix">
                            ...
                            <hr/>
                            <div>
                                <input type="hidden" name="random_token" value="<?php echo e(bcrypt($str)); ?>">
                                <div class="form-group clearfix">
                                    <label for="host" class=" col-md-3">Database Host</label>
                                    <div class="col-md-9">
                                        <input type="text" value="<?php echo e(old('host') ?? 'localhost'); ?>" id="host" name="host" autofocus
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class=" col-md-9">
                                        <input type="text" value="<?php echo e(old('db_user') ?? ''); ?>" name="db_user"
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class=" col-md-9">
                                        <input type="password" value="<?php echo e(old('db_password') ?? ''); ?>" name="db_password"
                                               class="form-control" autocomplete="off"
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class=" col-md-9">
                                        <input type="text" value="<?php echo e(old('db_name') ?? ''); ?>" name="db_name"
                        ...
                        <div class="section clearfix">
                            ...
                            <div>
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="<?php echo e(old('first_name') ?? ''); ?>" id="first_name"
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class=" col-md-9">
                                        <input type="text" value="<?php echo e(old('last_name') ?? ''); ?>" id="last_name"
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class=" col-md-9">
                                        <input type="text" value="<?php echo e(old('email') ?? ''); ?>" name="email"
                        ...
                        <div class="section clearfix">
                            ...
                            <div>
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="<?php echo e(old('purchase_code') ?? ''); ?>" id="purchase_code"
...
<script type="text/javascript" src="<?php echo e(static_asset('admin/js/jquery-3.6.0.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(static_asset('install/js/install.js')); ?>"></script>
</html>



<?php /**PATH D:\yoori-ecommerce\resources\views/install/index.blade.php ENDPATH**/ ?>